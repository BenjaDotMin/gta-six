...
const Jason = () => {
  useGSAP(() => {
    ...
    gsap.to('.jason .img-box', {
      scrollTrigger: {
        trigger: '.jason',
        start: 'top center', //top of element hits top center screen
        end: '80% center', //80 from top of element hits center screen
        scrub: 2, //delay/smoothen by 2s
        //markers:true
      },
      //animation
      y: -300, duration: 1, ease: 'power1.inOut' //add some parallax
